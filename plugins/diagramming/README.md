...
![Three-tier request flow](./examples/01-client-api-db.svg?v=2)
...
![Service mesh — xDS / Envoy](./examples/02-service-mesh-xds.svg?v=2)
...
![OAuth2 / JWT flow](./examples/03-oauth-flow.svg?v=2)
...
![Event-driven CQRS](./examples/04-event-driven-cqrs.svg?v=2)
...
![Multi-tenant KMS](./examples/05-multi-tenant-kms.svg?v=2)
